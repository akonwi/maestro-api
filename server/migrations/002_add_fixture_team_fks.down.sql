...
INSERT INTO fixtures_old (id, league_id, season, home_id, away_id, timestamp, finished, home_goals, away_goals)
  SELECT id, league_id, season, home_id, away_id, timestamp, finished, home_goals, away_goals
  FROM fixtures;

DROP TABLE fixtures;
ALTER TABLE fixtures_old RENAME TO fixtures;

...
func (s *State) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.KeyMsg:
		{
			...
			// Delete confirmation is now handled by BetDash
			...
			// Key handling for betting overview is now handled by BetDash.Update()
	...
	case AllBetsLoaded:
		bets := []Bet(msg)
		s.betDash.LoadData(s.betDash.bettingPerformance, bets)
		return s, nil
	...
	case ViewBettingOverview:
		s.betDash, listCmd = s.betDash.Update(msg)
		return s, listCmd
	case ViewMatches:
		if s.showBetForm {
